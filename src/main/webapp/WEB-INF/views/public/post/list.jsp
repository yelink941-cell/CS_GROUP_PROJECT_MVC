...
<head>
    ...
    <style>
        /* ============================================
           PUBLIC POSTS PAGE - SAME COLORS AS CATEGORY
           ============================================ */
        ...
        * {
        ...
        .library-card .card-state {
            display: flex;
            align-items: center;
            gap: 8px;
        }
        
        .library-card .public-label {
            background: #dcfce7;
            color: #16a34a;
            padding: 2px 10px;
            border-radius: 12px;
        ...
        .library-card .view-count-text {
            font-size: 12px;
            color: #94a3b8;
            font-weight: 500;
        }
        
        .library-card .view-count-text::before {
            content: "👁️ ";
        }
        ...
        .library-card .card-meta-left strong {
            font-size: 14px;
            color: #1e293b;
            display: block;
        }
        
        .library-card .card-meta-left a {
            text-decoration: none;
            color: inherit;
        }
        
        .library-card .card-meta-left a:hover {
            color: #4f46e5;
        }
        
        .library-card .card-meta-left small {
            font-size: 12px;
            color: #94a3b8;
        }
        
        .library-card .follow-btn {
            background: none;
        ...
        .library-card .follow-btn.following {
            background: #f1f5f9;
            border-color: #cbd5e1;
            color: #475569;
        }
        
        .library-card .follow-btn.following:hover {
            background: #fee2e2;
            border-color: #ef4444;
            color: #dc2626;
        }
        
        .library-card .follow-btn.not-following {
            background: #4f46e5;
            border-color: #4f46e5;
            color: white;
        }
        
        .library-card .follow-btn.not-following:hover {
            background: #4338ca;
            border-color: #4338ca;
        }
    ...
    <main>
        ...
        <header class="library-header">
            <div class="header-content">
                ...
                <h1><span><c:out value="${pageTitle}" /></span></h1>
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <form action="${pageContext.request.contextPath}/user/follow" method="POST" style="margin: 0;">
                                                    <input type="hidden" name="targetId" value="${post.author.id}" />
                                                    <button type="submit" class="follow-btn not-following">
                                                        ➕ Follow
                                                    </button>
                                                </form>
                                            </c:otherwise>
