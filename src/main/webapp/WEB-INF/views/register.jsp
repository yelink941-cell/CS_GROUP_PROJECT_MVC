...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
        ...
        /* Dynamic Registration Two-Column Split */
        ...
        /* Radio Circle Selection Design Accent */
        ...
        .radio-circle-label input[type="radio"]:focus { box-shadow: 0 0 0 3px rgba(230, 126, 34, 0.15); }
        .radio-circle-label:hover input[type="radio"] { border-color: #94a3b8; }
        .radio-circle-label:hover input[type="radio"]:checked { border-color: #e67e22; }

        /* Custom File Attachment Engine Customizer */
...
<body>
    ...
    <script>
        // Update label upon file selection box changes
